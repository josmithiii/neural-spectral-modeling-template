...
%% \begin{wideslide}[\slideopts,toc={}]{Summary of Resources Online}
%%   \begin{itemize}
%%   \item \emph{Neural Spectral Modeling Template (NSMT):}\\
%%     \href{https://github.com/josmithiii/neural-spectral-modeling-template.git}
%%   \item[]
...
%%   \item[]
%%   \item JOS Home Page (Videos, Overheads, including these):\\
%%     \href{https://ccrma.stanford.edu/~jos/Welcome.html}{\texttt{https://ccrma.stanford.edu/\~{}jos/}}
%%   \item[]
%% % \item[]
%% %  \item \emph{Take 1} of this talk (correlated but different):\\
%% %    \href{https://ccrma.stanford.edu/~jos/mp4/ADCxGather-take1-2024-10-26-20-E1.mp4}
%% %    {\texttt{https://ccrma.stanford.edu/\~{}jos/mp4/ADCxGather-take1-2024-10-26-20-E1.mp4}}
%%   \end{itemize}
%% \end{wideslide}
